...
function format_ID_value(value, ID_type, ID_MPL){
	var unit='';
        switch(ID_type) {
			...
			case 14: unit="l/s"; break; //l_per_s
        ...
        switch(unit) {
			...
			case "kBTu": value=value*3.41214;break;
			case "MBTu": value=(value*3.41214)/1000;break;
        }
...
function format_AI_value(AI_value, AI_type, AI_display, AI_pressuremeasurement, AI_absATMpres) {
    ...
    if(value==32767) {
        ...
        switch(AI_type) {
			...
			value=value/100;unit=$('#P option:selected').attr('value')+(AI_pressuremeasurement==1?"(a)":"");break;
            case 10:unit="%";break;
			...
			case 30: unit="l/min";break;
			case 34: value=value/10; unit="m³/h"; break;
