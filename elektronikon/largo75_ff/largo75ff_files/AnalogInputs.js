...
function A_2000_AI(QUESTIONS,JSON, JSON_ES)
{
    var error="";
        ...
        try {
            if (QUESTIONS.getData(i, 1).Byte(0) != 0) {
				...
				vAnalogInput.absATMpres = QUESTIONS.getData(0x260B,3).UInt16(0);
					//Also for ES pressure masterbar
					JSON_ES.PRESSUREMEASUREMENT =vAnalogInput.PRESSUREMEASUREMENT;
					JSON_ES.absATMpres = vAnalogInput.absATMpres;
				}
