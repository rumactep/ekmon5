...
public class AnalogInputView : IView {
    ...
    public string GetString() {
        ...
        return
            $"MPL:{_item.MPL} {strMpl}, RTD_SI:{_item.RTD_SI}, INPUTTYPE:{_item.INPUTTYPE}, DISPLAYPRECISION:{_item.DISPLAYPRECISION}, getValue:{strValue}, getStatus:{_item.getStatus()}\n";
    }
